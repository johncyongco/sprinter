...
export default function SettingsPage() {
  ...
  return (
    ...
    >
      ...
      <section className="rounded-[32px] border border-border bg-surface p-8 space-y-8">
      ...
      <section className="rounded-[32px] border border-border bg-surface p-8 space-y-6">
